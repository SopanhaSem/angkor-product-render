export const cardComponents = (product) => {
  return ` <div class="flex flex-col text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96 m-20 ">
   <div class=" mx-4 mt-4 overflow-hidden text-gray-700 bg-white bg-clip-border rounded-xl h-96">
     <img
       src= ${
         product.imageUrl ??
